...
1) Ensure that your test files are inside a folder named '/haxby2001-188B'
    If you want to change the name of the folder, edit line 306 (below) in run_all.py, and change 
    /haxby2001-188B to your desired file name. 
        cwd = os.getcwd()+'/haxby2001-188B'

2) Place the test models in the same directory as your test files. 
